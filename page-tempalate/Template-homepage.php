                ...
                <div class="testimonial-box">
                    <div class="testimonial-list">
                        <div class="item">
                            ...
                            <h3>“CybelAngel identifies exposed data on connected storage devices that we do not see with
                                other solutions.”</h3>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-head">
                    ...
                    <div class="content">
                        <p>We take pride in protecting a global network of 100’s of enterprise clients, knowing they are more secure because of our advanced EASM protection.</p>
                    </div>
                    <a href="#" class="btn btn-sweet">Why CybelAngel?</a>
                </div>                
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-and-img-block">
                    <div class="content-box">
                        <div class="title-content-box">
                            ...
                            <div class="content">
                                <p>External Attack Surface Management from CybelAngel let’s you see beyond perimeters and find peace of mind knowing you can find it and remediate it, before hackers even know it’s there.</p>
                            </div>
                    ...
                    <div class="img-box">
                        <div class="image-container">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/web-security.jpg" alt="Web Security">
                        </div>
                    </div>
                </div>
                ...
                <div class="text-and-img-block img-left">
                    ...
                    <div class="img-box">
                        <div class="image-container">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/human-with-machine.jpg" alt="Web Security">
                        </div>
                    </div>
                </div>
            </div>
